...
func (x *Renderer) RenderSearch(w io.Writer, r *http.Request) {
	...
	renderNode(w, HTML5(HTML5Props{
		...
		Head: []Node{
			...
			Link(Rel("preload"), Href("/fonts/figtree-latin-var.woff2"), As("font"), Type("font/woff2"), Attr("crossorigin")),
			Link(Rel("preload"), Href("/fonts/jetbrains-mono-latin-var.woff2"), As("font"), Type("font/woff2"), Attr("crossorigin")),
...
func initialPageState(q url.Values) PageState {
	form := SearchForm{
		...
		TextMainContentOnly:    queryBool(q, "textMainContentOnly", true),
